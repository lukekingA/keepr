...
namespace keepr.Repositories
{
  public class VaultKeepRepo
  {
    ...
    internal bool DeleteVaultKeep(int vaultId, int keepId)
    {
      return _db.Execute("DELETE FROM  vaultKeeps WHERE vaultId = @vaultId AND keepId = @keepId", new { vaultId, keepId }) > 0;
